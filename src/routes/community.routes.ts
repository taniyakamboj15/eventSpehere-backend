...
import { createCommunity, joinCommunity, leaveCommunity, getCommunities, getCommunityEvents, getMyCommunities, getCommunityMembers, removeMember, inviteMember } from '../modules/community/community.controller';
...
router.post('/', authenticate, authorize([UserRole.ORGANIZER, UserRole.ADMIN]), createCommunityValidation, createCommunity);
